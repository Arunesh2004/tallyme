...
export class TallyConnector implements ERPConnector {
  ...
  async postVoucher(request: ERPRequest): Promise<ERPResponse> {
    try {
      ...
      const rawResponse = await this.httpClient.post(
        xml,
  ...
  async updateVoucher(req: ERPRequest): Promise<ERPResponse> {
    return { success: true };
  }
  async deleteVoucher(id: string): Promise<ERPResponse> {
    return { success: true };
  }
  async createLedger(req: ERPRequest): Promise<ERPResponse> {
    return { success: true };
  }
  async updateLedger(req: ERPRequest): Promise<ERPResponse> {
    return { success: true };
  }
  async fetchCompany(): Promise<ERPResponse> {
    return { success: true };
  }
